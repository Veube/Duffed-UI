...
v.Text2:SetText("by |cffff0000tukz@tukui.org|r, website at |cffff0000www.tukui.org|r")
v:FontString("Text3", C.media.font, 12)
v.Text3:SetPoint("CENTER", 0, 5)
v.Text3:SetText("Edited by: |cffff0000Merith|r formerly by: |cffff0000Duffed|r")
...
vicon:CreatePanel(nil, 66, 66, "RIGHT", v, "LEFT", -2, 0)
...
viconl:CreatePanel(nil, 64, 64, "BOTTOMRIGHT", f, "TOPRIGHT", 0, 2)
...
viconr:CreatePanel(nil, 64, 64, "BOTTOMLEFT", f, "TOPLEFT", 0, 2)
...
title:CreatePanel(nil, f:GetWidth() - 130, 30, "BOTTOM", f, "TOP", 0, 2)
...
name:SetText("|cffc41f3bDuffedUI|r")
