...
TukuiBar2Button.text = T.SetFontString(TukuiBar2Button, C["media"].font, C["datatext"].fontsize)
...
TukuiBar2Button:SetScript("OnEnter", function(self) self:SetBackdropBorderColor(unpack(C["media"].datatextcolor1)) end)
...
TukuiBar3Button2:Hide()
TukuiBar3Button2:SetScript("OnClick", function(self) UpdateBar(self, TukuiBar3) end)
if C["actionbar"].rightbarsmouseover == true then
